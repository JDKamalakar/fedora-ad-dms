#!/usr/bin/env bash
# ==============================================================================
# Active Directory & SSSD Automated Lab Setup (setup-ad-dms-tui.sh)
# ==============================================================================
set -euo pipefail
...
echo "======================================================================"
echo "🖥️  AD DMS AUTOMATED SETUP (Host-Based Access Control)"
echo "======================================================================"
...
if [ -n "$MATCHED_AD_GROUP" ]; then
    ...
    # Block all lab groups EXCEPT the matched one for this host
...
if systemctl is-active --quiet sssd; then
    ...
    echo "❌ SSSD failed to start. Run 'journalctl -u sssd -xe' for logs."
    exit 1
fi
echo "======================================================================"
